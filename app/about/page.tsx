    ...
    <>
      ...
      <article className="prose-ev max-w-3xl">
        ...
        <ul>
          ...
          <li>
            <strong>해설은 직접 씁니다</strong> — 가이드와 차종·지역 해설은 환경부 보조금 업무처리지침, 지자체 공고, 제작사 공개 자료를 읽고 운영자가
            직접 정리합니다. 다른 사이트의 글을 옮기거나 자동 생성한 문장을 그대로 싣지 않습니다.
          </li>
          <li>
            <strong>기준 시각을 함께 표시</strong> — 표마다 수집 시각과 출처 배지를 붙이고, 가이드에는 게시일·업데이트일을 적습니다. 값이 바뀌면
            표는 자동으로, 해설은 사람이 확인해 갱신합니다.
          </li>
          <li>
