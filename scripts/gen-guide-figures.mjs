...
const FIGURES = {
  ...
  "subsidy-stack": stack({
    ...
    layers: [
      ...
      { label: "지방비 (시·군·구)", sub: "서울 194만원 ~ 경북 울릉 1,224만원", color: C.g2, text: C.ink },
      { label: "전환지원금 · 추가 인센티브", sub: "내연기관차 처분 +100만원, 다자녀·청년 등", color: C.amber2, text: C.ink },
    ],
    total: ["예) 서울 + 아이오닉 6 롱레인지", "570 + 191 + 100 = 약 861만원", "예) 경북 울릉군 동일 차종", "570 + 1,203 + 100 = 약 1,873만원"],
  ...
  "region-compare": hbarChart({
    ...
    items: [
      { label: "경북 울릉군", value: 1773, color: C.g1 },
      { label: "전남 완도군", value: 1525, color: C.g1 },
      { label: "경기 파주시", value: 1012, color: C.g2 },
      { label: "충남 천안시", value: 963, color: C.g2 },
      { label: "경기 성남시", value: 865, color: C.g3 },
      { label: "서울 강남구", value: 761, color: C.g3 },
    ],
    footnote: "국비 570 + 지방비(최대액 × 98.3%) · 전환지원금 미적용 · 단위 만원",
  }),
  "sido-range": hbarChart({
    heading: "2026 시·도별 승용 지방비 최대액",
    items: [
      { label: "경북", value: 1224, color: C.g1 },
      { label: "전남", value: 972, color: C.g1 },
      { label: "경남", value: 754, color: C.g2 },
      { label: "제주", value: 700, color: C.g2 },
      { label: "전북", value: 700, color: C.g2 },
      { label: "경기", value: 615, color: C.g2 },
      { label: "충북·충남", value: 600, color: C.g3 },
      { label: "강원", value: 550, color: C.g3 },
      { label: "대전", value: 350, color: C.g3 },
      { label: "광주·세종", value: 300, color: C.g3 },
      { label: "울산", value: 221, color: C.g3 },
      { label: "서울·부산·대구·인천", value: 194, color: C.g3 },
    ],
    footnote: "시·도 내 가장 높은 시·군·구 기준 · 공개자료 취합",
  }),
  // 11. 테슬라
  "tesla-factors": flow({
  ...
  "tesla-compare": barChart({
    ...
    items: [
      ...
      { label: "경기 파주", value: 1012, sub: "아이오닉 6", color: C.g1 },
      { label: "경기 파주", value: 373, sub: "모델 Y", color: C.sky },
      { label: "경북 울릉", value: 1773, sub: "아이오닉 6", color: C.g1 },
      { label: "경북 울릉", value: 653, sub: "모델 Y", color: C.sky },
    ],
    max: 2000,
